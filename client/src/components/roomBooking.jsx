...
// plan room booking page:
// list out the rooms
// expand room when cliked to allow it to be booked
// only show rooms that are not currently booked out
// make a booking to the room
// return the time booked and the time out
// retunr who made the booking

// side of screen have a calender, below it have time slots
// on the right have all the rooms avalible
